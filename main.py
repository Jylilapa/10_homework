...
from src.csv_excel import transaction_read_csv, transaction_read_excel
...
def main():
    ...
    while True:
        if user_dialogue == "1":
            ...
            transactions = file_opening(path_to_file)
            break
        elif user_dialogue == "2":
            print("Для обработки выбран CSV-файл")
            transactions = transaction_read_csv(join_path_csv)
            break
        elif user_dialogue == "3":
            print("Для обработки выбран XLSX-файл")
            transactions = transaction_read_excel(join_path_exc)
            break
        else:
            user_dialogue = input(
